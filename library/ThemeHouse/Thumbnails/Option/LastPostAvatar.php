...
class ThemeHouse_Thumbnails_Option_LastPostAvatar
{
    /**
    ...
    public static function renderOption(XenForo_View $view, $fieldPrefix, array $preparedOption, $canEdit)
    {
        if (XenForo_Application::$versionId > 1020000) {
            ...
            $isLpaInstalled = !empty($addOns['ThemeHouse_LastPostAvatar']);
        } else {
            $isLpaInstalled = $this->getAddOnById('ThemeHouse_LastPostAvatar') ? true : false;
        }
        if ($isLpaInstalled) {
